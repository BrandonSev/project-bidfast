      ...
      <div className="profile__baner">
        ...
        <nav>
          <ul className={"container"}>
            ...
            <li>
                <svg width="20" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#a)"><path
                  ...
                  fill="#000"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>
              <a href={''} onClick={handleClick} id="offer">Déposer une annonce</a>
            </li>
            <li>
              <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.806 5.102c.473-.385.733-.898.733-1.443s-.26-1.057-.733-1.443L16.824.598C16.35.212 15.724 0 15.056 0c-.667 0-1.295.212-1.766.597L0 11.413v4.505h5.516l13.29-10.816Zm-3.75-3.061 1.984 1.617-1.987 1.617-1.983-1.618 1.986-1.616ZM2.5 13.877V12.26l8.8-7.162 1.982 1.619-8.798 7.16H2.5ZM0 17.96h20V20H0v-2.04Z" fill="#000"/></svg>
