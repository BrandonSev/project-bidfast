...
const NewBid = () => {
    ...
    return (
      <Formik
        initialValues={{title: '', startPrice: 0, expireAt: '', image: '', content: '', userId: userId}}
        validate={values => {
          const errors = {};
          if (!values.title) {
        ...
        onSubmit={async (values, {setSubmitting}) => {
          ...
          await axios.post(`http://localhost:3001/api/offers/create`, formData, {
        ...
        {({
          ...
          <div className="container">
            ...
            <form action="#" className="new__bid" onSubmit={handleSubmit}>
              <div className="grid">
                <div className="grid__group">
                  ...
                  <input type="text" id="title" name="title" value={values.title}
                         className={errors.title ? 'input-error' : ''} onBlur={handleBlur} onChange={handleChange}/>
                  <div className="error">
                ...
                <div className="grid__group">
                  ...
                  <input type="number" id="startPrice" name="startPrice" value={values.startPrice}
                         className={errors.startPrice ? 'input-error' : ''} onBlur={handleBlur} onChange={handleChange}/>
                  <div className="error">
                ...
                <div className="grid__group">
                  ...
                  <input type="datetime-local" id="expireAt" name="expireAt"
                         ...
                         value={values.expireAt} onChange={handleChange}/>
                  <div className="error">
                ...
                <div className="grid__group">
                  ...
                  <input type="file" id="image" value={values.email} className={errors.image ? 'input-error' : ''}
                ...
                <div className="grid__group">
                  ...
                  <textarea id="content" rows={10} value={values.content} className={errors.content ? 'input-error' : ''}
              ...
              <button type="submit" className="btn btn-small btn-primary" disabled={isSubmitting}>Envoyer</button>
            </form>
          </div>
        )}
      </Formik>
